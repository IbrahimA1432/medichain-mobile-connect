...
const Landing = () => {
  const features = [
    {
      icon: QrCode,
      title: "QR Code-Powered Access",
      description: "Instant medical record access through simple QR scan - no internet required"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Instant record loading and updates with QR Code technology"
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Medical records accessible locally 24/7, even in areas with poor connectivity"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Transform healthcare with QR Code-powered medical records. Instant access, 
          ...
          <Card className="p-6 bg-gradient-card shadow-medical-lg">
            ...
            <div className="bg-primary/10 p-4 rounded-lg mb-4">
              <div className="flex items-center justify-center space-x-2 text-primary">
                ...
                <span className="text-sm font-medium">Ready to scan QR Code...</span>
              </div>
            </div>
            <p className="text-xs text-muted-foreground">
              Scan patient's QR Code to instantly load medical records
            </p>
          </Card>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Improvements for Healthcare Providers
              </h2>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Complete data sovereignty with QR code storage
                    </p>
                  </div>
                </div>
              </Card>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            ...
            and see how QR Code technology can revolutionize your practice.
          </p>
      ...
      <footer className="border-t bg-card/50 py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Revolutionizing healthcare through QR Code technology
          </p>
        </div>
      </footer>
    </div>
